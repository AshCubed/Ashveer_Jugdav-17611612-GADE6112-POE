...
namespace Task_3
{
    class NeutralUnit : Unit
    {
        ...
        public NeutralUnit(int xPosition, int yPosition, int health, int speed, bool attack, int attackRange, string factionTeam, string symbolImage, string name)
        ...
        override public void save()
        {
            ...
            try
            {
                ...
                outFile = new FileStream(@"Files\NeutralUnit.txt", FileMode.Append, FileAccess.Write);
